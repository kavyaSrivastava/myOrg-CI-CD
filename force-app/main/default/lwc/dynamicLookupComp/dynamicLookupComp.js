...
export default class DynamicLookupComp extends LightningElement {
    ...
    //           fetchDefaultRecord({ objectFieldName: this.sObjectFieldName , 'sObjectApiName' : this.sObjectApiName })
    //           .then((result) => {
    //               if(result != null){
    ...
    //        }
      ...
      @wire(fetchLookupData, { sobjectFieldName: this.objectFieldName , sObjectName : this.objectName })
       searchResult(value) {
          const { data, error } = value; // destructure the provisioned value
          this.isSearchLoading = false;
          this.initialRecords = value.data;
          if (data) {
